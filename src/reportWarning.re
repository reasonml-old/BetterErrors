...
let report ::refmttypePath code filePath parsedContent =>
  ...
  | Warning_OptionalArgumentNotErased {argumentName} =>
    sp
      ...
      argumentName
      argumentName ^ "The rule: an optional argument is erased as soon as the 1st positional (i.e. neither labeled nor optional) argument defined after it is passed in."
